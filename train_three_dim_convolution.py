...
from three_dimensional_convolution import three_dim_Classifier

pdb_folder = 'pdb_structures_sep_tpo'
true_csv = 'ungrouped_fold_job_jan_25.csv'
false_csv = 'negatives_jan_25.csv'
...
for epoch in range(epochs):
    ...
    for batch in progress_bar:
        ...
        outputs = model(coords).squeeze()  # 🔹 Remove extra dimensions for BCE loss
...
print("Training complete. Model saved as 'experimental_three_dim_convolution_PhosNet.pth'")
